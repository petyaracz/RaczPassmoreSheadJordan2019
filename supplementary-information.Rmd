...
Since the frequency measure and word length are both word-level predictors, we have no potential random slopes and report the model with a word random intercept only. The estimates of the fixed effects can be seen in the figure below.
